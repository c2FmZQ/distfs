...
distfs mkdir /integrity || echo "integrity dir already exists"

echo "Uploading critical file..."
echo "integrity-protected-data" > /tmp/crit.txt
distfs put /tmp/crit.txt /integrity/critical.txt
...
distfs get /integrity/critical.txt /tmp/crit-back.txt
